...
namespace WaveNET.Core.Model.Document.Operation
{
	...
	{
		private List<DocOpComponent> _components = new List<DocOpComponent>();
		...
		{
			_components.Add(WaveNET.Core.Model.Document.Operation.DeleteElementEnd.Instance);
		}
		...
		{
			_components.Add(WaveNET.Core.Model.Document.Operation.ElementEnd.Instance);
		}
	}
}
