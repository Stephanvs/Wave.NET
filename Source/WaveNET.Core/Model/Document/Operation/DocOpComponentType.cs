...
namespace WaveNET.Core.Model.Document.Operation
{
	...
	/// </summary>
	/// <seealso cref="http://code.google.com/p/wave-protocol/source/browse/src/org/waveprotocol/wave/model/document/operation/DocOpComponentType.java"/>
	public class DocOpComponentType
	{
		public static DocInitializationComponentType AnnotationBoundary = new DocInitializationComponentType("annotation boundary");
